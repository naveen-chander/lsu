...
HD_PWD='C:/Users/mghnv/drive/Documents/MtechProject/LSU_counter/LSU_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lsu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lsu_wrapper.tcl
