...
HD_PWD='C:/Users/mghnv/drive/Documents/MtechProject/LSU_counter/LSU_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lsu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lsu_wrapper.tcl -notrace
